...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "Mohamed.Selim@microsoft.com"
    ...
    primary_hub_address_space                          = "10.1.0.0/22"
    primary_sidecar_virtual_network_address_space      = "10.1.4.0/22"
    primary_bastion_subnet_address_prefix              = "10.1.4.0/26"
    primary_private_dns_resolver_subnet_address_prefix = "10.1.4.64/28"
  }
